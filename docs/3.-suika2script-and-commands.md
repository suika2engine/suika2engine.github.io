...
In the meantime, please see [Calling an Advanced Script](https://github.com/suika2engine/suika2/blob/master/doc/requirements-specification.md#calling-an-advanced-script) for more information.
