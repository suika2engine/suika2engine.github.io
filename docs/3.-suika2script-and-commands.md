---
title: Suika2Script and Commands
---
...
for more information, see [`@chs`](#changing-characters-and-background-at-once-chs).
...
Character image files need to be stored in the [`ch`](#ch-folder) folder.
...
For more information regarding NVL-style, see [Creating an NVL-style Story](creating-an-nvl-style-story).
